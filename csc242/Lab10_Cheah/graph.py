...
class LinkedVertex(object):
    ...
    def __init__(self, label):
        ...
        self._edgeList = list()
        self._mark = False
        self._fromEdgeList = list() # Ricky - This, and edgeList keeps track of neighbours
    ...
    def addEdgeTo(self, toVertex, weight):
        ...
        toVertex._fromEdgeList.append(edge) # Ricky - This, and edgeList keeps track of neighbours
    ...
    def neighboringVertices(self):
        ...
        for edge in self._fromEdgeList:
            vertices.append(edge.getOtherVertex(self))            
    ...
    def removeEdgeTo(self, toVertex):
        ...
        if edge in self._edgeList:
            ...
            toVertex._fromEdgeList.remove(edge)
            return True
        else:
            return False
